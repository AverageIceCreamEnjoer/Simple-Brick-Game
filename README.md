# Simple-Brick-Game
Резюме: в данном проекте я реализовал игры «Змейка» и «Тетрис» на языке программирования С++ в парадигме объектно-ориентированного программирования.
## Введение
...
Для формализации логики игры необходимо использовать конечные автоматы.
